...
All paths are relative to the repo root (the directory containing `CLAUDE.md`), which is the working directory for every command below. The Python interpreter for any script is `researchEnv/bin/python3`.
